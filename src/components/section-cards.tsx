...
import { getOnlineAHUCount, getTotalAHUCount, getTotalEnergyConsumption, getTotalEnergySaved } from "@/data/ahu-data";
...
export function SectionCards() {
    ...
    const moneySaved = totalEnergySaved * 10;
                ...
                <CardHeader>
                    <CardDescription className="flex items-center gap-2">
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent>
                                <p>Cost savings from energy efficiency (₹10 per kWh saved)</p>
                            </TooltipContent>
                        </Tooltip>
                    </CardDescription>
                    <CardTitle className="text-xl font-semibold tabular-nums @[250px]/card:text-2xl">
